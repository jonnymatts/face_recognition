...
public class ImageHelper {
	...
	public static double bilinearInterpolation(Mat img, double x, double y) {
		...
		double xMin = floor(x); int xMinIndex = (int)xMin;
		double xMax = ceil(x); int xMaxIndex = (int)xMax;
		double yMin = floor(y); int yMinIndex = (int)yMin;
		double yMax = ceil(y); int yMaxIndex = (int)yMax;
